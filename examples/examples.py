...
def run_examples() -> None:
    # give input data
    targets = [
        Target("A", (0.0, 10.0), (0.01, 0.0), (0.0, 40.0), 2.0),
        Target("B", (8.0, 0.0), (0.0, 0.02), (0.0, 100.0), 2.0),
        Target("C", (5.0, 5.0), (-0.01, -0.015), (0.0, 50.0), 2.0),
        Target("D", (1.0, 6.0), (-0.01, 0.02), (0.0, 50.0), 2.0),
        Target("E", (2.0, 2.0), (0.01, -0.015), (0.0, 100.0), 2.0),
        Target("F", (0.0, 0.0), (0.0, -0.02), (0.0, 1000.0), 2.0),
    ]

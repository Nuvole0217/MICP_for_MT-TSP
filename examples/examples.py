...
def run_examples() -> None:
    # give input data
    targets = [
        Target("A", (0.0, 10.0), (0.01, 0.0), (0.0, 1750.0), 1.5),
        Target("B", (8.0, 0.0), (0.0, 0.02), (0.0, 100.0), 1.5),
        Target("C", (5.0, 5.0), (-0.01, -0.015), (0.0, 200.0), 1.0),
        Target("D", (1.0, 6.0), (-0.01, 0.02), (0.0, 150.0), 1.5),
        Target("E", (2.0, 2.0), (0.01, -0.015), (0.0, 150.0), 1.5),
        Target("F", (0.0, 0.0), (0.0, -0.02), (0.0, 100.0), 1.5),
        Target("G", (4.0, 8.0), (0.01, 0.0), (0.0, 200.0), 1.0),
        Target("H", (6.0, 2.0), (0.0, 0.01), (0.0, 200.0), 1.0),
        Target("I", (9.0, 9.0), (0.0, 0.0), (0.0, 100.0), 1.0),
        Target("J", (3.0, 3.0), (0.0, 0.0), (0.0, 100.0), 1.0),
        Target("K", (7.0, 7.0), (0.0, 0.0), (0.0, 100.0), 1.0),
        # Target("L", (10.0, 10.0), (0.0, 0.0), (0.0, 150.0), 1.0),
        # Target("M", (0.0, 5.0), (0.01, 0.0), (0.0, 150.0), 1.5),
    ...
    model = MTSPMICPGCS(targets, depot=(0.0, 4.0), max_time=200.0, vmax=1.0)
    tour = model.solve()
    print("Tour:", tour)
    viz = Visualizer(
